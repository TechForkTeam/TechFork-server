...
public class RecommendationController {
    ...
    public ResponseEntity<BaseResponse<RecommendationListResponse>> getRecommendations(
        ...
        RecommendationListResponse response = recommendationQueryService.getRecommendations(userPrincipal.getId());
    ...
    public ResponseEntity<BaseResponse<Void>> regenerateRecommendations(
        ...
        recommendationCommandService.regenerateRecommendations(userPrincipal.getId());
