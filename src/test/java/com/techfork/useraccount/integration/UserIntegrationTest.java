 ...
 * User API 통합 테스트
 */
class UserIntegrationTest extends MySqlRedisIntegrationTestBase {
    ...
    class GetMyProfile {
        ...
        void authenticatedUser_ReturnsProfile() throws Exception {
            // When & Then
    ...
    class UpdateMyProfile {
        ...
        void nicknameOnly_ReturnsUpdatedProfile() throws Exception {
            // Given
        ...
        void descriptionOnly_ReturnsUpdatedProfile() throws Exception {
            // Given
        ...
        void nicknameAndDescription_ReturnsUpdatedProfile() throws Exception {
            // Given
        ...
        void emptyRequest_ReturnsCurrentProfile() throws Exception {
            // Given
        ...
        void updatedProfile_ReturnsChangedProfile() throws Exception {
            // Given
    ...
    @Nested
    @DisplayName("PUT /api/v1/users/me/interests")
    class UpdateMyInterests {

        @Test
        @DisplayName("내 관심사 수정 실패 - 관심사 카테고리는 필수")
        void blankCategory_ReturnsBadRequest() throws Exception {
            String requestBody = """
                    {
                      "interests": [
                        {
        ...
        void nullInterestItem_ReturnsBadRequest() throws Exception {
            String requestBody = """
                    {
                      "interests": [null]
                    }
        ...
        void blankKeyword_ReturnsBadRequest() throws Exception {
            String requestBody = """
                    {
                      "interests": [
                        {
    ...
    @Nested
    @DisplayName("PATCH /api/v1/users/me/withdrawal")
    class WithdrawUser {

        @Test
        @DisplayName("회원 탈퇴 성공")
        void authenticatedUser_ReturnsOkAndMarksWithdrawn() throws Exception {
            // When
