...
class AuthIntegrationTest extends MySqlRedisIntegrationTestBase {
    ...
    class RefreshToken {
        ...
        void validRefreshToken_ReturnsAccessTokenAndCookie() throws Exception {
            // When & Then
        ...
        void tokenMismatch_InvalidatesSessionAndReturnsUnauthorized() throws Exception {
        ...
        void noTokenInRedis_InvalidatesSessionAndReturnsUnauthorized() throws Exception {
        ...
        void missingRefreshToken_ReturnsUnauthorized() throws Exception {
            // When & Then
            mockMvc.perform(post("/api/v1/auth/refresh"))
                    .andDo(print())
                    .andExpect(status().isUnauthorized())
        ...
        void invalidTokenFormat_ReturnsUnauthorized() throws Exception {
            // When & Then
            mockMvc.perform(post("/api/v1/auth/refresh")
    ...
    class Logout {
        ...
        void validRefreshToken_DeletesTokenAndCookie() throws Exception {
            // When & Then
    ...
    class KakaoLogin {
        ...
        void newUser_ReturnsUnregisteredUserAndCookie() throws Exception {
        ...
        void existingUser_ReturnsRegisteredUserAndCookie() throws Exception {
            // Given: 기존 사용자 생성
        ...
        void kakaoApiError_ReturnsUnauthorized() throws Exception {
